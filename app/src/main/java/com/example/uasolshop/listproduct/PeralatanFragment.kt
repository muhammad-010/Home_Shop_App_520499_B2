...
import com.example.uasolshop.databinding.FragmentPeralatanBinding
 ...
 * Use the [PeralatanFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PeralatanFragment(parentFragment: FragmentManager) : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PeralatanFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(parentFragmentManager: FragmentManager, param1: String, param2: String) =
            PeralatanFragment(parentFragmentManager).apply {
